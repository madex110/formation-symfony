...
class RegistrationType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('introduction', TextType::class, $this->getConfiguration('Intoduction', 'Présentez-vous en quelques mots'))
            ->add('description', TextareaType::class, $this->getConfiguration('Description détaillée', "C'est le moment de se présenter en détails !"));
    }
